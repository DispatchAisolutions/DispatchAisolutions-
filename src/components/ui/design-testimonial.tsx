...
const testimonials = [
  {
    quote: "We learn your workflow, pinpoint the biggest bottleneck, and define what success looks like.",
    author: "Step 01",
    role: "Goals & Bottlenecks",
    company: "Discovery",
  },
  {
    quote: "We build your AI system, connect it to your website and business tools, and test it end-to-end.",
    author: "Step 02",
    role: "Scripts & Integrations",
    company: "Build",
  },
  {
    quote: "We launch, monitor conversations, and optimize based on real data.",
    author: "Step 03",
    role: "Monitoring & Iteration",
    company: "Deploy",
  },
]
